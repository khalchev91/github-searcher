...
@override
  void initState() {
    _githubSearchBloc = GithubSearchBloc(githubRepository: widget.githubRepository);
    super.initState();
  }
...
class _SearchBar extends StatefulWidget{
  ...
  _SearchBar({Key key, this.githubSearchBloc});
    ...
    return BlocBuilder<GithubSearchEvent, GithubSearchState>(
      ...
      builder: (BuildContext context,GithubSearchState state){
        if(state is SearchStateEmpty){
          return Text('Please enter a search term to begin');
        }
